...
const EmailVerification = () => {
  ...
  const verifyEmail = async () => {
    ...
    try {
      await axios
        .patch(`http://127.0.0.1:8000/send-verification/${email}/`)
        .then((val) => {
    ...
    <div className="flex items-center justify-center flex-col my-5">
      <section className="max-w-2xl mx-auto bg-white">
        ...
        <main className="mt-8 px-5 sm:px-10">
          ...
          <p className="mt-2 leading-loose text-gray-600 ">
            Please Click yellow button with Verify email text to verify your
            email
          </p>
          <p className="mt-4 leading-loose text-gray-600">
            Clicking the yellow button will only be valid for the next
        ...
        <footer className="mt-8">
          <div className="bg-gray-300/60 h-[200px] flex flex-col gap-3 justify-center items-center">
            <div className="text-center flex flex-col gap-2">
              ...
              <a
                href="tel:+251-488-838-3803"
                className="text-gray-500"
                alt="+251-488-838-3803"
              >
                +251-488-838-3803
              </a>
              <a
                href="mailto:team@gyhon.com"
                className="text-gray-500"
                alt="team@gyhon.com"
              >
                team@gyhon.com
          ...
          <div className="bg-[#365CCE] py-5 text-white text-center">
            <p className="mt-3 ">
              © {new Date().getFullYear()} Gyhon Team. All Rights Reserved.
            </p>
          </div>
        </footer>
      </section>
      {isVerifying && (
        <div>
          ...
          <p>You will be Redirecting to login page in 30 seconds...</p>
        </div>
      )}
      {verificationError && (
        <div className="">
        ...
        <Card className="mx-auto w-full max-w-[24rem]">
          <CardBody className="flex flex-col gap-4">
            ...
            <Typography className="-mb-2" variant="h6">
              Verification link sent successfully ! please check you email if
              not found in primary please check in spam or trash folder
            </Typography>
          </CardBody>
          <CardFooter className="pt-0">
            <Button variant="gradient" onClick={backToLogin} fullWidth>
              Back to Login
            </Button>
          </CardFooter>
        </Card>
